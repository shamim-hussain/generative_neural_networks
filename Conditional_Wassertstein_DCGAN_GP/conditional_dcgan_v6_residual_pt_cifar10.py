...
x = dd_in
x = vggmodel.get_layer('block1_conv1')(x)
y = Dense(64)(c_emb)
x = Lambda(lambda els: els[0] + els[1][:, None, None, :])([x, y])
x = LeakyReLU()(x)

#x = vggmodel.get_layer('block1_conv2')(x)
#y = Dense(64)(c_emb)
#x = Lambda(lambda els: els[0] + els[1][:, None, None, :])([x, y])
#x = LeakyReLU()(x)
...
x = vggmodel.get_layer('block2_conv1')(x)
y = Dense(128)(c_emb)
x = Lambda(lambda els: els[0] + els[1][:, None, None, :])([x, y])
x = LeakyReLU()(x)

#x = vggmodel.get_layer('block2_conv2')(x)
#y = Dense(128)(c_emb)
#x = Lambda(lambda els: els[0] + els[1][:, None, None, :])([x, y])
#x = LeakyReLU()(x)
...
x = vggmodel.get_layer('block3_conv1')(x)
y = Dense(256)(c_emb)
x = Lambda(lambda els: els[0] + els[1][:, None, None, :])([x, y])
x = LeakyReLU()(x)
x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
...
optgan = Adam(lr=0.75e-5, beta_1=0., beta_2=.9)
optcrit = Adam(lr=0.75e-5, beta_1=0., beta_2=.9)
